...
public interface PropertyRepository extends JpaRepository<Property, Long> {
    ...
    @Query("SELECT new com.greenhome.api.dto.property.PropertySummary(p.tag, p.name, p.status, MIN(ap.area), MAX(ap.area), MIN(ap.bedroomCount), MAX(ap.bedroomCount), pd.documentUUID, '')" +
            "FROM Property p " +
